...
VERSION = "$Revision: 2458 $".split()[1]     #extract CVS version
...
if   plat[:5] == 'linux':    #Linux (confirmed)
    ...
    def device(port): # tested with keyspan USP-to-serial adapters
                      # others might use /dev/tty.usbserialXX
        return '/dev/cu.USA19QW%sP1.1' % ('1' * (port + 1))
